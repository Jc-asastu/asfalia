...
const STR = {
  en: {
    ...
    copy_contract: 'Copy full contract address',
    theme_light: 'Light mode (paper)',
    theme_dark: 'Dark mode (tablet)',
  ...
  es: {
    ...
    copy_contract: 'Copiar la dirección completa del contrato',
    theme_light: 'Modo claro (papel)',
    theme_dark: 'Modo noche (tablilla)',
